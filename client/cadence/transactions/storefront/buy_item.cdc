...
transaction(listingResourceID: UInt64, storefrontAddress: Address, commissionRecipient: Address?) {
    ...
    let closeFarNFTCollection: &CloseFarNFT.Collection{NonFungibleToken.Receiver}
    ...
    prepare(acct: AuthAccount) {
        ...
        self.closeFarNFTCollection = acct.borrow<&CloseFarNFT.Collection{NonFungibleToken.Receiver}>(
    ...
    execute {
        ...
        self.closeFarNFTCollection.deposit(token: <-item)
    }
}
