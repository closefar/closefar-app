...
access(all) contract CloseFarNFT: NonFungibleToken {
    ...
    access(all) resource NFT: NonFungibleToken.NFT {
        ...
        access(all) fun createEmptyCollection(): @{NonFungibleToken.Collection} {
            return <-CloseFarNFT.createEmptyCollection(nftType: Type<@CloseFarNFT.NFT>())
        }
        ...
        access(all) fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return CloseFarNFT.resolveContractView(resourceType: Type<@CloseFarNFT.NFT>(), viewType: Type<MetadataViews.NFTCollectionData>())
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return CloseFarNFT.resolveContractView(resourceType: Type<@CloseFarNFT.NFT>(), viewType: Type<MetadataViews.NFTCollectionDisplay>())
                ...
                case Type<MetadataViews.EVMBridgedMetadata>():
                    ...
                    let contractLevel = CloseFarNFT.resolveContractView(
                            resourceType: nil,
    ...
    access(all) resource interface CloseFarNFTCollectionPublic {}

    access(all) resource Collection: NonFungibleToken.Collection, CloseFarNFTCollectionPublic {
        ...
        access(all) view fun getSupportedNFTTypes(): {Type: Bool} {
            ...
            supportedTypes[Type<@CloseFarNFT.NFT>()] = true
        ...
        access(all) view fun isSupportedNFTType(type: Type): Bool {
            return type == Type<@CloseFarNFT.NFT>()
        }
        ...
        access(all) fun deposit(token: @{NonFungibleToken.NFT}) {
            ...
            CloseFarNFT.emitNFTUpdated(authTokenRef)
        }
        ...
        switch viewType {
            case Type<MetadataViews.NFTCollectionData>():
                let collectionData = MetadataViews.NFTCollectionData(
                    ...
                    publicCollection: Type<&CloseFarNFT.Collection>(),
                    publicLinkedType: Type<&CloseFarNFT.Collection>(),
    ...
    init() {
        ...
        let collectionCap = self.account.capabilities.storage.issue<&CloseFarNFT.Collection>(self.CollectionStoragePath)
